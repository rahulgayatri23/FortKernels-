...
void set_imag(double val) 
{
    ...
    friend inline GPUComplex GPUComplex_plus(const GPUComplex& a, const GPUComplex & b); 
...
//Device Functions 
    ...
    friend __device__ void d_GPUComplex_minusEquals( GPUComplex& a, const GPUComplex & b); 
...
/*
 * Return the complex number c = a * b (a is complex, b is complex) 
 */
