...
__global__  void cudaBGWKernel( GPUComplex *wtilde_array, GPUComplex *aqsntemp, GPUComplex *I_eps_array, int ncouls, double wxt, double& achtemp_re_iw, double& achtemp_im_iw, int my_igp, GPUComplex mygpvar1, int n1, double vcoul_igp)
{
    ...
    double achtemp_re = 0.00;
    double achtemp_im = 0.00;
...
void gppKernelGPU( GPUComplex *wtilde_array, GPUComplex *aqsntemp, GPUComplex *I_eps_array, int ncouls, double wxt, double &achtemp_re_iw, double &achtemp_im_iw, int my_igp, GPUComplex mygpvar1, int n1, double vcoul_igp, int numBlocks, int numThreadsPerBlock)
{
    ...
    cudaBGWKernel <<< numBlocks, numThreadsPerBlock>>> ( wtilde_array, aqsntemp, I_eps_array, ncouls, wxt, achtemp_re_iw, achtemp_im_iw, my_igp, mygpvar1, n1, vcoul_igp);
}
